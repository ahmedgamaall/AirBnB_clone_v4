...
$('.checkboxState').click(function () {
    ...
    if (Object.keys(checkBoxStates).length === 0 && Object.keys(checkBoxCities).length === 0) {
      $('.locations h4').html('&nbsp;');
    } else {
      $('.locations h4').text(Object.values(checkBoxStates).concat(Object.values(checkBoxCities)).join(', '));
    }
  });
  ...
  $('.checkboxCity').click(function () {
    ...
    if (Object.keys(checkBoxStates).length === 0 && Object.keys(checkBoxCities).length === 0) {
      ...
      $('.locations h4').text(Object.values(checkBoxCities).concat(Object.values(checkBoxStates)).join(', '));
    }
  });
